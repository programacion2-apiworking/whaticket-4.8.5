            ...
            {(values) => (
                <Form className={classes.fullWidth}>
                    <Grid spacing={1} justifyContent="flex-start" container>
                        ...
                        <Grid xs={12} sm={8} md={2} item>
                            <FormControl margin="dense" variant="outlined" fullWidth>
                                <InputLabel htmlFor="useIntegrations-selection">Integración</InputLabel>
                                <Field
                                    as={Select}
            ...
            >
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell align="center">Integración</TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    {records.map((row) => (
                        <TableRow key={row.id}>
                            ...
                            <TableCell align="center">{i18n.t("plans.form.money")} {row.value ? row.value.toLocaleString('es', { minimumFractionDigits: 2 }) : '00.00'}</TableCell>
...
export default function PlansManager() {
    ...
    const handleSelect = (data) => {
        ...
        setRecord({
            ...
            value: data.value?.toLocaleString('es', { minimumFractionDigits: 0 }) || 0,
            useCampaigns,
            useSchedules,
            useInternalChat,
            useExternalApi,
