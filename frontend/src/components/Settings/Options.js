...
const useStyles = makeStyles((theme) => ({
  ...
  tab: {
    backgroundColor: theme.palette.options,  //DARK MODE WADO DESIGN//
    borderRadius: 4,
    width: "100%",
    "& .MuiTab-wrapper": {
      color: theme.palette.fontecor,
    },   //DARK MODE WADO DESIGN//
...
export default function Options(props) {
  ...
  // recursos a mais da WADO design
      ...
      <Grid spacing={3} container>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingUserRating && "Actualización..."}
            </FormHelperText>
          </FormControl>
        </Grid>
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingScheduleType && "Actualización..."}
            </FormHelperText>
          </FormControl>
        </Grid>
        <Grid xs={12} sm={6} md={4} item>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingChatbotType && "Actualización..."}
            </FormHelperText>
          </FormControl>
        </Grid>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingSendGreetingAccepted && "Actualización..."}
            </FormHelperText>
          </FormControl>
        </Grid>
        {/* ENVIAR SAUDAÇÃO AO ACEITAR O TICKET */}
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingSettingsTransfTicket && "Actualización..."}
            </FormHelperText>
          </FormControl>
        </Grid>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingSendGreetingMessageOneQueues && "Actualización..."}
            </FormHelperText>
          </FormControl>
        </Grid>
      ...
      <Grid spacing={3} container
        ...
        <Grid xs={12} sm={6} md={6} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingIpIxcType && "Actualización..."}
            </FormHelperText>
          </FormControl>
        </Grid>
        <Grid xs={12} sm={6} md={6} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingTokenIxcType && "Actualización..."}
            </FormHelperText>
          </FormControl>
        </Grid>
      </Grid>
      ...
      <Grid spacing={3} container
        ...
        <Grid xs={12} sm={12} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingIpMkauthType && "Actualización..."}
            </FormHelperText>
          </FormControl>
        </Grid>
        <Grid xs={12} sm={12} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingClientIdMkauthType && "Actualización..."}
            </FormHelperText>
          </FormControl>
        </Grid>
        <Grid xs={12} sm={12} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingClientSecrectMkauthType && "Actualización..."}
            </FormHelperText>
          </FormControl>
        </Grid>
      </Grid>
      ...
      <Grid spacing={3} container
        ...
        <Grid xs={12} sm={12} md={12} item>
          <FormControl className={classes.selectContainer}>
            ...
            <FormHelperText>
              {loadingAsaasType && "Actualización..."}
            </FormHelperText>
          </FormControl>
        </Grid>
      </Grid>
