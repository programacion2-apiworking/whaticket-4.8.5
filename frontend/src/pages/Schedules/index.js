...
import "./Schedules.css"; // Importe el archivo CSS

// Defina la función getUrlParam antes de usarla
...
const eventTitleStyle = {
  fontSize: "14px", // Defina un tamaño de fuente menor
  overflow: "hidden", // Oculte cualquier contenido excedente
  whiteSpace: "nowrap", // Evite la ruptura de línea del texto
